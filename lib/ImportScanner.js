...
export default class ImportScanner {
    static create(filePath, token, onProgress) {
        return new ImportScanner(filePath, token, onProgress);
    }

    constructor(filePath, token, onProgress) {
        Object.assign(this, { filePath, token, onProgress });
        this.files = [];
